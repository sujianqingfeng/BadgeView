...
public class BadgeViewHelper {
     ...
     * @param color 颜色值
     */
    public void setBagdeBgColor(int color){
        mBadgeBgColor=color;
        mBadgeInterface.postInvalidate();
    }
     ...
     * @param color 颜色值
     */
    public void setBagdeTextColor(int color){
    ...
    public void setBadgePadding(int padding){
        if (padding>0){
            mBadgePadding=BadgeViewUtil.dp2px(mBadgeInterface.getContext(),padding);
            mBadgeInterface.postInvalidate();
        }
    }
     ...
     * @param gravity 位置
     */
    public void setBadgeGravity(BadgeGravity gravity){
